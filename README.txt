...
Used Python 3.12.5 and installed numpy, tifffile, zipfile, pytorch, torchvision via pip.
...
Used Godot 4.5-latest. Prior versions may not work.


***DATA INSTALL***
From the project directory, create a directory named Data, and a subdirectory zips. Inside of the Data/zips, create:
-A subdirectory titled gm_el_v2-master, containing the .zips of https://github.com/globalmaps/gm_el_v2_west and https://github.com/globalmaps/gm_el_v2_east.
-A subdirectory titled gm_lc_v3-master, containing the .zips of https://github.com/globalmaps/gm_lc_v3.
-A subdirectory titled gm_ve_v2-master, containing the .zips of https://github.com/globalmaps/gm_ve_v2.
Any README.md files in these directories will be ignored, so you do not need to worry about including or excluding them.
...
3b. If you want to try multiple parameter settings at once, without having to start the run every time, you can write these configurations into parameter_sweep.py and run it.
